...
<script>
	...
	function editSu(editBtn){						// [수정]버튼 클릭
		...
		var arr = rStr.split(",");
		var query = "cartUpdateForm.do?cart_id="+arr[0];
	...
	function delList(delBtn){						// [삭제]버튼 클릭
		...
		var query = "deleteCart.do?list="+rStr;
	    window.location.href=query;
	}
</script>
		      ...
		      <td colspan="5" align="center">
		         <div id="cinfo">
			         <table>
			         	<tr>
				           <td>
					           <form id="cartForm" method="post" action="buyForm.do">
						           <input type="hidden" name="buyer" value="${sessionScope.id}">
						           <input type="submit" value="구매하기">
				           		</form>
				           	</td>
				           <td>
					           <form id="cartClearForm" method="post" action="deleteCart.do">
